          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="mb-4 text-base text-neutral-600 dark:text-neutral-200">
                Transform your unique ideas into products that resonate with your audience. We
                bridge the gap between your creativity and commerce.
              </p>
              <button
                type="button"
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="mb-4 text-base text-neutral-600 dark:text-neutral-200">
                ...
                creativity should be your only investment. Earn a competitive commission on every
                sale as your creations capture the market.
              </p>
            </div>
          </div>
        </div>
